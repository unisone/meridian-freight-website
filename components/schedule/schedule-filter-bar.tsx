...
export function ScheduleFilterBar({
  ...
  return (
    <div className="sticky top-[72px] z-30 -mx-4 sm:-mx-6 lg:top-20 lg:-mx-8 px-4 sm:px-6 lg:px-8 py-3 bg-background/95 supports-[backdrop-filter]:bg-background/80 backdrop-blur-sm border-b">
