          ...
          <div className="relative aspect-video bg-gray-900">
            {isPlaying ? (
              ...
              >
                ...
                {/* Play button */}
                <div className="relative flex h-20 w-20 items-center justify-center rounded-full bg-blue-600 shadow-xl transition-all group-hover:scale-110 group-hover:bg-blue-700">
