...
export default async function CalculatorV2RollbackPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const calculatorJsonLd = {
    ...
    description:
      "Free online calculator for estimating machinery export costs including inland freight, packing, and ocean shipping.",
