...
const servicesEn: Service[] = [
  ...
  },
  {
    ...
    longDescription:
      "Missing or incorrect paperwork is the number one cause of port delays. Meridian prepares and coordinates U.S./Canada export-side documentation — commercial invoices, packing lists, bills of lading, certificates of origin, phytosanitary certificates, AES/EEI filings — and can coordinate with destination-side customs brokers. Destination import clearance, taxes, permits, and local filings must be confirmed by the buyer's licensed broker or importer unless that destination-side service is explicitly contracted.",
    icon: "FileText",
    ...
    faqs: [
      ...
      { question: "Do you handle customs paperwork for the destination country?", answer: "Meridian prepares and coordinates all U.S./Canada export-side documentation and can coordinate with destination-side customs brokers. Destination import clearance, taxes, permits, and local filings (such as Brazil's import licenses, Turkey's TAREKS, or Saudi Arabia's SABER) must be confirmed by the buyer's licensed broker or importer unless a separate destination-side service is explicitly contracted.", category: "Documentation" },
...
const servicesEs: Service[] = [
  ...
  },
  {
    ...
    longDescription:
      "La documentación faltante o incorrecta es la causa número uno de retrasos en puerto. Meridian prepara y coordina la documentación de exportación de EE.UU./Canadá — facturas comerciales, listas de empaque, conocimientos de embarque, certificados de origen, certificados fitosanitarios, AES/EEI — y puede coordinar con el despachante aduanal en destino. La nacionalización, tributos, permisos y trámites locales en el país de destino los confirma su despachante o importador licenciado, salvo que se contrate explícitamente un servicio local adicional.",
    icon: "FileText",
    ...
    faqs: [
      ...
      { question: "¿Manejan los trámites aduaneros del país de destino?", answer: "Meridian prepara y coordina la documentación de exportación de EE.UU./Canadá y puede coordinar con el despachante aduanal en el puerto de destino. La nacionalización, los tributos, permisos y trámites locales en el país de destino los confirma su despachante o importador licenciado, salvo que se contrate explícitamente un servicio local adicional.", category: "Documentación" },
