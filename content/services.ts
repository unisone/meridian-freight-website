...
const servicesEs: Service[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "¿Qué pasa si la documentación es incorrecta o falta?", answer: "La documentación incorrecta causa retrasos portuarios y cargos por almacenaje — a veces miles de dólares. Por eso manejamos cada documento internamente y lo verificamos tres veces antes del envío. En más de 500 exportaciones, tenemos una tasa de liberación a la primera casi perfecta.", category: "Documentación" },
...
const servicesRu: Service[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "Что происходит при некорректной или отсутствующей документации?", answer: "Некорректные документы вызывают задержки в порту и плату за хранение — иногда тысячи долларов. Поэтому мы оформляем каждый документ внутри компании и перепроверяем трижды перед отправкой. В более чем 500 экспортных операциях мы имеем почти идеальный показатель прохождения таможни с первого раза.", category: "Документация" },
