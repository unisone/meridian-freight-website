...
export const kazakhstanMarketPage: KazakhstanMarketPageContent = {
  ...
  hero: {
    ...
    highlights: [
      "Один контакт по американской части: продавец, забор, разборка, упаковка, документы и фрахт.",
      "Заранее проверяем, что влезает в 40HC, что нужно везти на flat rack и где можно использовать свободное место.",
      "Отдельно показываем нашу часть расчета и то, что должен подтвердить ваш таможенный представитель в Казахстане.",
    ],
    whatsappMessage:
  ...
  marketContext: {
    ...
    cards: [
      ...
      },
      {
        ...
        description:
          "Костанай, Акмолинская область, Северный Казахстан, Кокшетау и Астана чаще связаны с крупными зерновыми хозяйствами. Там чаще считают комбайны, мощные тракторы, жатки, сеялки и запчасти к уборке.",
      },
      {
  ...
  scope: {
    ...
    intro:
      "Чтобы не смешивать все в одну непонятную сумму, мы показываем, за что отвечает Meridian, и что нужно заранее проверить с таможенным представителем или декларантом в Казахстане.",
    ...
    included: [
      ...
      "Разборка под контейнер: колеса, жатка, шнек, зеркала, навесное — по ситуации.",
    ...
    excluded: [
      ...
      "Выбор схемы ввоза, импортера и получателя груза.",
      "Финальный расчет налогов и платежей по конкретной машине.",
    ],
    note:
  ...
  equipmentFocus: {
    ...
    title: "Какая техника из США обычно стоит отдельного расчета",
    intro:
      "США стоит смотреть, когда речь идет о дорогой машине, редкой комплектации, хорошем состоянии или запчастях, которые сложно быстро закрыть на месте.",
    items: [
      {
        title: "Комбайны и уборочная техника",
        summary:
          "John Deere S-Series, Case IH Axial-Flow, Claas Lexion и похожие машины нужно считать по габаритам, жатке, шнеку, колесам и способу загрузки.",
        fit:
          "Хороший вариант для расчета, если вы уже нашли конкретный комбайн и хотите понять доставку до покупки.",
      ...
      },
      {
        ...
        summary:
          "John Deere 8R/9R, Magnum, Steiger и похожие классы требуют проверки ширины, колес, навески, веса и варианта погрузки.",
        fit:
      ...
      },
      {
        ...
        fit:
          "Это хороший кандидат для консолидации, если контейнер в Казахстан уже планируется и в нем остается место.",
      ...
      },
      {
        ...
        summary:
          "Двигатели, мосты, колеса, решета, шнеки, гидравлика и электроника требуют нормальной упаковки и понятной маркировки.",
        fit:
  ...
  process: {
    ...
    intro:
      "Начинаем не с абстрактного тарифа, а с конкретной машины. На расчет влияют город продавца, габариты, тип контейнера, порт, сроки и требования по оформлению в Казахстане.",
    steps: [
      {
        step: "01",
      ...
      {
        step: "05",
        title: "Передаем документы и статус",
        description:
  ...
  faq: {
    ...
    entries: [
      ...
      },
      {
        ...
        answer:
          "Иногда да, но это зависит от модели комбайна, ширины жатки, шнека, колес, свободного места и выбранного контейнера. Часто комбайн и жатку нужно считать отдельно. Лучше проверить это по фото и габаритам до оплаты продавцу.",
        category: "Казахстан",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Да. Мы можем организовать забор у дилера, фермы, аукционной площадки или частного продавца. Если покупка еще не закрыта, пришлите ссылку на объявление — проверим логистику и риски до оплаты.",
        category: "Казахстан",
      },
      {
  ...
  proofLinks: [
    ...
    },
    {
      ...
      description:
        "Если машина еще не выбрана, можно начать с поиска и проверки объявлений.",
    },
  ],
};
