...
const faqEntriesEs: FaqEntry[] = [
  ...
  },
  {
    ...
    answer: "Sí — atendemos consultas en español por WhatsApp. Envíenos un mensaje con los detalles de su equipo (marca, modelo, año) y destino, y le respondemos con una cotización detallada dentro de 24 horas. También puede llamarnos o enviar un correo a alex.r@meridianexport.com y copiar a alex.z@meridianexport.com.",
    category: "General",
  },
];
